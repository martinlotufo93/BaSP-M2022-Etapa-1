console.log ("Exercise number 5: For");
//Point A
...
var secondarray = ["montaña", "bosque", "lago", "arbol", "cielo"];
...
console.log ("The single variable converted to a single string is:" + " " + sentence);
console.log ("------------------------------------");
...
console.log ("Full array with numbers from 0 to 9:" + " " + emptyarray);
console.log ("------------------------------------");
console.log ("------------------------------------");
console.log ("------------------------------------");